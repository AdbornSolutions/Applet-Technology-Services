...
const Footer = () => {
  return (
    <footer
      className="bg-cover bg-center bg-[#EFF1F3] bg-no-repeat pt-[125px] pb-[200px] "
      style={{ backgroundImage: `url(${footerBg})` }}
    >
      <div className="max-w-[1080px] mx-auto px-5">
        {/* CTA */}
        <div className="text-center mb-[55px]">
          <h2 className="text-[34px] leading-[45px] font-medium text-[#202020]">
            Ready to Bring Your Dreams to Life?
            <br />
            Let’s <span className="text-[#6946ff]">Get Started</span> Today
          </h2>

          <div className="mt-[28px] flex justify-center gap-[14px]">
            <input
              type="email"
              placeholder="Enter You’re email"
              className="w-[285px] h-[36px] rounded-full px-[16px] text-[12px] outline-none bg-white"
            />

            <Link
              to="/contact"
              className="h-[36px] px-[20px] rounded-full bg-[#6b46ff] text-white text-[13px] flex items-center gap-2"
            >
              Let’s Talk
              <FiArrowRight />
            </Link>
        ...
        {/* Footer Card */}
        <div className="bg-white rounded-[14px] px-[38px] pt-[30px] pb-[24px]">
          <div className="grid grid-cols-4 gap-[55px]">
            <div>
              <img src={logo} alt="Applet Technology Services" className="w-[205px] mb-[24px]" />
          ...
          <div className="border-t border-[#ddd] mt-[28px] pt-[18px] flex justify-between text-[11px] text-[#111]">
